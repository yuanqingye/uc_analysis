...
次日留存率,新老用户都有一定的波动,老用户留存率每一天都高于新用户,节日期间留存率高,6月18日留存率有个波谷
...
近两周整体pv因端午节出现高峰,**在6月16日到6月18日达到高峰，而在其余时间相对较低**
...
对于用户访问时长作的热力图    
在本报告所覆盖的两周     
6月16日这天访问时间明显更长,新用户访问时长普遍低于于老用户,6月18日之前比之后访问时间更长        
...
机型中iphone手机排名前列，前十三名均被iphone系列手机占据,安卓机中MI 6,OPPO R9M,Redmi Note 4X,OPPO R9s,MHA-AL00,OPPO Redmi Note 3排名前二十,值得注意的是新手机iPhone 8 Plus排入第13,iPhone 8排第20,     本阶段节日流量出现暴增,排名前三的iphone5系列并非当下常见机型
...
melt_df_city_top20 = melt(new_user_by_city_date_ordered_reshape[3:22,-ncol(new_user_by_city_date_ordered_reshape)], id.vars = "city", measure.vars = 2:(ncol(new_user_by_city_date_ordered_reshape)-1), variable.name = "date", value.name = "value")
...
#temp process
new_user_by_city_date_ordered_reshape = new_user_by_city_date_ordered_reshape[c(-1,-2),]
...
上海,北京,长沙,南京,合肥,徐州,宁波,无锡,武汉,苏州占据前十名    

**合肥,徐州,无锡,郑州,扬州,青岛,哈尔滨,昆明,保定,廊坊,长春,开封,东莞,贵阳,唐山,邯郸,临沂名次上升较多**    
**厦门,大连,重庆,福州,杭州,南昌,台州,绍兴,湖州,金华,赣州,衢州等城市名次下降较多**

这两周，流量整体很大,合肥,徐州,宁波等不少城市流量比较异常，各个城市名次相对过去两周变动很大
...
IOS二维码推广第一,android二维码推广第二,Appstore第三,小米第四,华为第五,oppo推广第六,百度助手第七,然后是vivo,30015,豌豆荚,应用宝,二维码-其他,360助手等,新的渠道锤子进入第14
...
在APP上有过活动的人生成的订单占比较少,高峰发生在6月16日到6月18日（节假日也是周末）,峰值有25000单以上,订单次高峰发生在6月23日到6月24日,峰值有6000单左右,平时订单很少,基本在5000单以下,周末订单较多,周一到周日有上升趋势
...
**整体预约平稳趋势**，6月16日预约很多,预约达到500以上,6月7日，6月14日也很多,在400附近,除这几天，预约数在200附近徘徊，6月17日后,预约数降低,降低到50以下    
整体相比上月,有了明显上升
...
领券情况呈现从第一周第一天到第二周最后一天不断上升的趋势    
这两周的趋势总体除去每周波动比较稳定，在6月16日到6月18日（最后两天）达到峰值    
不过值得注意的是,6月18日节日之后,领券人数几乎为零    
