...
次日留存率,老用户有一定的波动,新用户普遍较低波动不大,老用户留存率每一天都高于新用户,节日期间留存率高,7月2日留存率最低,7月12日留存率最高
...
对于用户访问时长作的热力图    
在本报告所覆盖的两周     
在每周的周末,新用户访问时间更长,在每周的工作日,老用户访问时间更长    
新用户访问时长波动大于老用户,当新用户达到访问时长波峰时,高于老用户,位于波谷时,低于老用户    
不过第二周新用户一直偏低,而7月10日更是达到历史低点    
...
机型中iphone手机排名前列，前十三名均被iphone系列手机占据,安卓机中MI 6,MHA-AL00,OPPO R11,OPPO R9s,Redmi Note 4X,Redmi Note 3,Mi Note 3排名前二十,值得注意的是新手机iPhone X 排名第8,iphone7排名第11,iPhone 8 Plus排入第15,iPhone SE排第17    
本阶段,排名前三的iphone5系列并非当下常见机型    
...
宁波,长沙,上海,厦门,北京,徐州,南京,大连,石家庄,南京占据前十名    
**宁波,厦门,徐州,大连,石家庄,广州,扬州,昆明,绍兴,贵阳,南通,邢台,太原,济宁,泉州,芜湖,南阳,马鞍山,菏泽,周口,淄博,镇江,连云港,南宁,嘉兴,焦作,聊城,遵义,衡阳,上饶,南充等城市上升较多**
**武汉,合肥,无锡,常州,金华,泰州,赣州,晋城,泰安,湖州,襄阳,鞍山等城市下降较多**    

这两周，流量整体不大,长沙,宁波等城市流量比较异常,但整体看各个城市还算正常,各个城市名次相对过去两周变动很大
...
IOS二维码推广第一,小米第二,Appstore第三,oppo推广第四,华为第五,vivo第六,android二维码推广第七,30015第七，然后是百度助手,二维码-其他,豌豆荚,应用宝,360助手等,新的渠道VIVO应用商店，锤子,金立易用汇进入前20
...
在APP上有过活动的人生成的订单占比较少,高峰发生在7月14日到7月15日（周末）,峰值有12000单左右，订单次高峰发生在7月7日到7月8日，峰值有8000单左右,平时订单很少,基本在4000单以下,周末订单较多,周一到周日有上升趋势
...
领券情况除去第一天，呈现从第一周第一天到第二周最后一天不断上升的趋势    
在每周周末达到峰值,第二周周末比第一周周末有明显提升    
不过值得注意的是,领券人数相对节假日偏少       
